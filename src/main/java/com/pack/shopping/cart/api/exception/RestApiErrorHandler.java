...
public class RestApiErrorHandler {
    ...
    public ResponseEntity<Error> handleMethodNotAllowedException(
        ...
        ex.printStackTrace(); // * Should be kept only for development
        Error error = ErrorUtils
                .createError(String.format("%s. Supported methods: %s", ex.getMessage(), ex.getSupportedMethods()),
                        ErrorCode.HTTP_REQUEST_METHOD_NOT_SUPPORTED.getErrCode(),
    ...
    public ResponseEntity<Error> handleHIllegalArgumentException(
        ...
        Error error = ErrorUtils
                .createError(
                        String.format("%s %s", ErrorCode.ILLEGAL_ARGUMENT_EXCEPTION.getErrMsgKey(), ex.getMessage()),
