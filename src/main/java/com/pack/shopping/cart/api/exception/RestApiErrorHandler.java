...
public class RestApiErrorHandler {
        ...
        public ResponseEntity<Error> handleHttpMediaTypeNotSupportedException(HttpServletRequest request,
                ...
                Error error = ErrorUtils
                                ...
                                .setReqMethod(request.getMethod())
                                .setTimestamp(Instant.now());
                log.error("HttpMediaTypeNotSupportedException :: request.getMethod(): " + request.getMethod());
                return new ResponseEntity<>(error, HttpStatus.INTERNAL_SERVER_ERROR);
        }
        ...
        public ResponseEntity<Error> handleHttpMessageNotWritableException(HttpServletRequest request,
                ...
                Error error = ErrorUtils
                                ...
                                .setReqMethod(request.getMethod())
                                .setTimestamp(Instant.now());
                log.error("HttpMessageNotWritableException :: request.getMethod(): " + request.getMethod());
                return new ResponseEntity<>(error, HttpStatus.INTERNAL_SERVER_ERROR);
        }
        ...
        public ResponseEntity<Error> handleHttpMediaTypeNotAcceptableException(HttpServletRequest request,
                ...
                Error error = ErrorUtils
                                ...
                                .setReqMethod(request.getMethod())
                                .setTimestamp(Instant.now());
                log.error("HttpMediaTypeNotAcceptableException :: request.getMethod(): " + request.getMethod());
                return new ResponseEntity<>(error, HttpStatus.INTERNAL_SERVER_ERROR);
        }
        ...
        public ResponseEntity<Error> handleHttpMessageNotReadableException(HttpServletRequest request,
                ...
                Error error = ErrorUtils
                                ...
                                .setReqMethod(request.getMethod())
                                .setTimestamp(Instant.now());
                log.error("HttpMessageNotReadableException :: request.getMethod(): " + request.getMethod());
                return new ResponseEntity<>(error, HttpStatus.INTERNAL_SERVER_ERROR);
        }
        ...
        public ResponseEntity<Error> handleJsonParseException(HttpServletRequest request,
                ...
                Error error = ErrorUtils
                                ...
                                .setReqMethod(request.getMethod())
                                .setTimestamp(Instant.now());
                log.error("JsonParseException :: request.getMethod(): " + request.getMethod());
                return new ResponseEntity<>(error, HttpStatus.INTERNAL_SERVER_ERROR);
        }
        ...
        public ResponseEntity<Error> handleHttpRequestMethodNotSupportedException(
                ...
                Error error = ErrorUtils
                                ...
                                .setReqMethod(request.getMethod())
                                .setTimestamp(Instant.now());
                log.error("HttpRequestMethodNotSupportedException :: request.getMethod(): " + request.getMethod());
        ...
        public ResponseEntity<Error> handleMethodNotAllowedException(
                ...
                ex.printStackTrace(); // * Should be kept only for development
                Error error = ErrorUtils
                                .createError(String.format("%s. Supported methods: %s", ex.getMessage(),
                                ...
                                .setReqMethod(request.getMethod())
                                .setTimestamp(Instant.now());
                log.error("MethodNotAllowedException :: request.getMethod(): " + request.getMethod());
        ...
        public ResponseEntity<Error> handleCustomerNotFoundException(HttpServletRequest request,
                ...
                Error error = ErrorUtils
                                .createError(
                                                String.format("%s %s", ErrorCode.CUSTOMER_NOT_FOUND.getErrMsgKey(),
                                                                ex.getMessage()),
                                                ex.getErrorCode(),
                                                HttpStatus.NOT_FOUND.value())
                                .setUrl(request.getRequestURL().toString())
                                .setReqMethod(request.getMethod())
                                .setTimestamp(Instant.now());
                log.error("CustomerNotFoundException :: request.getMethod(): " + request.getMethod());
                return new ResponseEntity<>(error, HttpStatus.NOT_FOUND);
        }
        ...
        public ResponseEntity<Error> handleItemNotFoundException(HttpServletRequest request,
                ...
                Error error = ErrorUtils
                                .createError(
                                                String.format("%s %s", ErrorCode.ITEM_NOT_FOUND.getErrMsgKey(),
                                                                ex.getMessage()),
                                                ex.getErrorCode(),
                                                HttpStatus.NOT_FOUND.value())
                                .setUrl(request.getRequestURL().toString())
